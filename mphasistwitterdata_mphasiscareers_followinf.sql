...
--
-- Table structure for table `mphasiscareers_followinf`
--

DROP TABLE IF EXISTS `mphasiscareers_followinf`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `mphasiscareers_followinf` (
...
--
-- Dumping data for table `mphasiscareers_followinf`
--

LOCK TABLES `mphasiscareers_followinf` WRITE;
/*!40000 ALTER TABLE `mphasiscareers_followinf` DISABLE KEYS */;
/*!40000 ALTER TABLE `mphasiscareers_followinf` ENABLE KEYS */;
UNLOCK TABLES;
